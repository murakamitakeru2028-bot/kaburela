...
function MoonIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" aria-hidden>
      <path
        d="M12.5 9.5a5.5 5.5 0 01-7-7 5.5 5.5 0 107 7z"
        stroke="currentColor"
        strokeWidth="1.25"
        strokeLinecap="round"
...
export function Header({ currentView, onViewChange, period, onPeriodChange, filter, onFilterChange, onSearchSelect }: HeaderProps) {
  ...
  return (
    ...
    >
      <div className="absolute inset-x-0 top-0 h-8 flex items-center px-5 gap-4">
        ...
        <div className="ml-auto flex items-center gap-3 shrink-0">
          ...
          <div className="relative">
            <button
              ...
              onMouseEnter={() => setHoverInfo({ desc: '相関係数の下限とセクターを絞り込みます。', side: 'right' })}
              onMouseLeave={() => setHoverInfo(null)}
              className={cn(
